...
M.base_30 = {
	...
	black = "{{colors.background.default.hex | lighten: -0.2}}", --  nvim bg
	...
	grey_fg = "{{colors.surface_variant.default.hex | lighten: 5.0}}",
	grey_fg2 = "{{colors.surface_variant.default.hex | lighten: 10.0}}",
	light_grey = "{{colors.on_surface_variant.default.hex | lighten: -20.0}}",
	red = "{{colors.error.default.hex}}",
	baby_pink = "{{colors.error.default.hex | lighten: 15.0}}",
	pink = "{{colors.tertiary_fixed.default.hex}}",
	line = "{{colors.surface_dim.default.hex}}", -- for lines like vertsplit
	green = "{{colors.tertiary.default.hex}}",
	vibrant_green = "{{colors.tertiary.default.hex | lighten: 10.0}}",
	nord_blue = "{{colors.primary.default.hex | lighten: 5.0}}",
	blue = "{{colors.primary.default.hex}}",
	yellow = "{{colors.secondary.default.hex}}",
	sun = "{{colors.secondary.default.hex | lighten: 10.0}}",
	purple = "{{colors.tertiary_fixed.default.hex | lighten: -5.0}}",
	dark_purple = "{{colors.tertiary_fixed.default.hex | lighten: -15.0}}",
	...
	statusline_bg = "{{colors.surface.default.hex | lighten: -10.0}}",
...
M.base_16 = {
	...
	base09 = "{{colors.secondary.default.hex | lighten: -10.0}}",
	...
	base0F = "{{colors.error.default.hex | lighten: 5.0}}",
}
